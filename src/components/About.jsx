  ...
  return (
    <div className="about">
      ...
      <div id="about">
        ...
        <p>I am a  Front End Engineer based in Accra, Ghana.
            </p>
        <p>
          I love developing softwares that run in your browser and I also love writing
          clean, effficient and elegant code.
        </p>
        <p>
